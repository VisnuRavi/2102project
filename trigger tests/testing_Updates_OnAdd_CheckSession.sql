--testing_FN_Updates_OnAdd_CheckSessionValidity
...
('22:00:00', CURRENT_DATE, 0, 0, 200,NULL),
('22:00:00', CURRENT_DATE + 3, 0, 0, 200,NULL),
('22:00:00', CURRENT_DATE + 4, 0, 0, 200,NULL);

--booker
INSERT INTO Joins VALUES
(200, 0, 0, '22:00:00', CURRENT_DATE),
(200, 0, 0, '22:00:00', CURRENT_DATE + 3),
(200, 0, 0, '22:00:00', CURRENT_DATE + 4);

--insert rest of joiners (2 more pax)
INSERT INTO Joins VALUES
(101, 0, 0, '22:00:00', CURRENT_DATE),
(103, 0, 0, '22:00:00', CURRENT_DATE),
(101, 0, 0, '22:00:00', CURRENT_DATE + 3),
(103, 0, 0, '22:00:00', CURRENT_DATE + 3),
(101, 0, 0, '22:00:00', CURRENT_DATE + 4),
(103, 0, 0, '22:00:00', CURRENT_DATE + 4);

--change capacity
--only session 3 should delete! (along with all the joiners)
change_capacity (0, 0, 2, CURRENT_DATE + 3, 300);