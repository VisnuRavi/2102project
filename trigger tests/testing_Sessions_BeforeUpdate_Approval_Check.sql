...
(CURRENT_DATE, 0, 0, 3, 300),
(CURRENT_DATE, 1, 0, 3, 301),
(CURRENT_DATE, 0, 1, 3, 302),
(CURRENT_DATE, 1, 1, 3, 303),
(CURRENT_DATE, 0, 2, 3, 304),
(CURRENT_DATE, 1, 2, 3, 305),
(CURRENT_DATE, 0, 3, 3, 306),
(CURRENT_DATE, 1, 3, 3, 307),
(CURRENT_DATE, 0, 4, 3, 308),
(CURRENT_DATE, 1, 4, 3, 309);

INSERT INTO Sessions VALUES
('20:00:00', CURRENT_DATE + 1, 0, 0, 200,NULL),
('21:00:00', CURRENT_DATE + 1, 0, 0, 200,NULL),
('22:00:00', CURRENT_DATE + 1, 0, 0, 200,NULL),

('10:00:00', CURRENT_DATE + 2, 0, 1, 200,300),

('21:00:00', CURRENT_DATE + 2, 0, 0, 200,NULL),
('22:00:00', CURRENT_DATE + 2, 0, 0, 200,NULL),

('20:00:00', CURRENT_DATE - 4, 0, 0, 200,NULL),
('06:00:00', CURRENT_DATE, 0, 0, 200,NULL),

('20:00:00', CURRENT_DATE + 3, 0, 0, 200,NULL);


--valid meeting, last session not booked
CALL approve_meeting(0, 0, CURRENT_DATE + 1, '20:00:00', '22:00:00', 300);
--no session found
CALL approve_meeting(0,0,CURRENT_DATE - 100, '20:00:00', '22:00:00', 300);
--previously approved
CALL approve_meeting(0,0,CURRENT_DATE + 2, '20:00:00', '21:00:00', 301);
--wrong dept
CALL approve_meeting(0,0,CURRENT_DATE + 2, '21:00:00', '22:00:00', 307);
--wrong date/time
CALL approve_meeting(0,0,CURRENT_DATE - 4, '20:00:00', '21:00:00', 300);
CALL approve_meeting(0,0,CURRENT_DATE, '06:00:00', '07:00:00', 300);
--resigned manager
CALL approve_meeting(0,0,CURRENT_DATE + 3, '20:00:00', '21:00:00', 301);